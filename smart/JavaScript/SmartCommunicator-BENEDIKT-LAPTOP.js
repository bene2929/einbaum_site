...
function changeOut(i) {
    ...
    $.post("SetLed.php", { status: text, id: i+1}, function (result) {
...
function showDB() {
    $.post("GetTable.php", {}, function (result) {
        document.getElementById("debug").innerHTML = "Sent:" + result;
    });
}
function loadValues() {
...
function createDB() {
    $.post("CreateDB.php", {ledNumber:ledNumber}, function (result) {
        document.getElementById("debug").innerHTML = "Sent:" + result;
    });
}
function read(isOverwrite) {

    $.post("GetLed.php", {}, function (result) {
    ...
    $.post("GetSensors.php", {}, function (result) {
...
function init(buildID) {
    ...
    sensorHandle.push({ handle: "temp0", status: -1.0, name: "Temperatur 0", unit:"°C" });
    sensorHandle.push({ handle: "moist0", status: -1.0, name: "Feuchtigkeit 0", unit: "%" });
    var site = "";
    var ledId="led";
    var sensId = "sens";
